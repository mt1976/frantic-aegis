...
func (record *Session_Store) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func postGetList(recordList *[]Session_Store) ([]Session_Store, error) {
...
func (record *Session_Store) postGet() error {
...
func (record *Session_Store) checkForDuplicate() error {
